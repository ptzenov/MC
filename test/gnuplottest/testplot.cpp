...
int main(void)
{
        ...
        plotter.set_line_width(1.5, 1);

        plotter.set_line_color("#FF0000", 2);
        plotter.set_line_width(1.5, 2);

        size_t const N = 200;

        std::array<double, N> x;
        std::array<double, N> sinx;
        std::array<double, N> cosx;
        ...
        plotter.hold_on();
        plotter.plot(x.begin(),sinx.begin(),N,1);
        plotter.set_line_specifier("linespoints");
	plotter.plot(x.begin(),cosx.begin(),N,2);
	plotter.hold_off();
